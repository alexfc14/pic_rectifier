...
def main():
    ...
    parser.add_argument("-c", "--columns", help="pattern columns", default="50", action="store", dest="columns",
                        type=int)
    parser.add_argument("-r", "--rows", help="pattern rows", default="25", action="store", dest="rows", type=int)
    ...
    parser.add_argument("-s", "--square_size", help="size of squares in pattern", default="10.0", action="store",
    ...
    parser.add_argument("-a", "--page_size", help="page size, superseded if -h and -w are set", default="A1",
